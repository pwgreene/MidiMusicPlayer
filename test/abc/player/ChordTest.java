...
public class ChordTest {
   /*Testing Strategy*/
    ...
    public void testChordTwoLowOctaveNotes() {
        SingleNote noteA = new SingleNote(new RationalNum(1, 1), new Pitch('A').transpose(-12));
        SingleNote noteB = new SingleNote(new RationalNum(1, 1), new Pitch('B').transpose(-12));
    ...
    public void testChordTwoMiddleOctaveNotes() {
        ...
        SingleNote noteC = new SingleNote(new RationalNum(1, 1), new Pitch('C'));
    ...
    public void testChordTwoHighOctaveNotes() {
        SingleNote noteD = new SingleNote(new RationalNum(1, 1), new Pitch('D').transpose(12));
        SingleNote noteE = new SingleNote(new RationalNum(1, 1), new Pitch('E').transpose(12));
    ...
    public void testChordMoreThanTwoNotes() {
        SingleNote noteA = new SingleNote(new RationalNum(1, 1), new Pitch('A').transpose(-12));
        SingleNote noteF = new SingleNote(new RationalNum(1, 1), new Pitch('F').transpose(1));
        SingleNote noteG = new SingleNote(new RationalNum(1, 1), new Pitch('G').transpose(12));
    ...
    public void testChordMultipleNotesDifferentLengths() {
        SingleNote noteB = new SingleNote(new RationalNum(4, 1), new Pitch('B'));
        SingleNote noteBflat = new SingleNote(new RationalNum(5, 1), new Pitch('B').transpose(-1)); //Bflat=Asharp
        SingleNote noteE = new SingleNote(new RationalNum(10, 1), new Pitch('E'));
    ...
    public void testGetDurationAllSameLengthTwoNotes() {
        SingleNote noteA = new SingleNote(new RationalNum(3, 1), new Pitch('A').transpose(12));
        SingleNote noteB = new SingleNote(new RationalNum(3, 1), new Pitch('B'));
        List<SingleNote> notes = Arrays.asList(noteA, noteB);
        Music chord = new Chord(notes);
    ...
    public void testGetDurationAllSameLengthThreeNotes() {
        SingleNote noteA = new SingleNote(new RationalNum(3, 1), new Pitch('A').transpose(12));
        SingleNote noteB = new SingleNote(new RationalNum(3, 1), new Pitch('B'));
        SingleNote noteG = new SingleNote(new RationalNum(3, 1), new Pitch('G'));
    ...
    public void testGetDurationDifferentLengthTwoNotes() {
        SingleNote noteA = new SingleNote(new RationalNum(3, 1), new Pitch('A').transpose(12));
        SingleNote noteB = new SingleNote(new RationalNum(5, 1), new Pitch('B'));
        List<SingleNote> notes = Arrays.asList(noteA, noteB);
        Music chord = new Chord(notes);
    ...
    public void testGetDurationDifferentLengthThreeNotes() {
        SingleNote noteA = new SingleNote(new RationalNum(3, 1), new Pitch('A').transpose(12));
        SingleNote noteC = new SingleNote(new RationalNum(8, 1), new Pitch('C'));
        SingleNote noteG = new SingleNote(new RationalNum(12, 1), new Pitch('G'));
