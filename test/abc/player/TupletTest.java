...
/*Testing Strategy*/
    ...
    public void testDupletLowerOctave() {
        Music noteC = new SingleNote(1, new Pitch('C').transpose(-12), 0);
    ...
    public void testTripletMiddleOctave() {
        Music noteD = new SingleNote(1, new Pitch('D'), 0);
    ...
    public void testTripletDifferentNotes() {
        Music noteD = new SingleNote(1, new Pitch('D'), 0);
        Music noteE = new SingleNote(1, new Pitch('E'), 0);
        Music noteF = new SingleNote(1, new Pitch('F'), 0);
    ...
    public void testQuadrupletHigherOctave() {
        Music noteC = new SingleNote(1, new Pitch('C').transpose(12), 1);
    ...
    public void testTripletDifferentOctaves() {
        Music lowA = new SingleNote(1, new Pitch('A').transpose(-12), -1);
        Music midA = new SingleNote(1, new Pitch('A'), -2);
        Music highB = new SingleNote(1, new Pitch('B'), 0);
